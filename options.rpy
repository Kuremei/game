...
define config.name = _("El destino nos une")
...
define config.version = "{color=#000000}1.0{/color}"


## Texto situado en la pantalla 'Acerca de' del juego. Sitúa el texto entre
## comillas triples y deja una línea en blanco entre párrafos.

define gui.about = _p("""{color=#000000}Historia 100% RivaMika

Mikasa se ha dado cuenta de que Eren se aleja cada vez más de ella, apartándola y alejándola de su camino. Por ello, comenzará a relacionarse con más personas y crear mas vínculos, incluso llegando a amar a la persona que menos esperaba.

Pero no todo es felicidad, el mundo es cruel y Mikasa lo sabe.

Tendrá que enfrentar duras situaciones para alcanzar la libertad y felicidad que tanto desea, llegando a hacer muchos sacrificios...Pero no lo hará sola. Ya que ella tiene un destino con una persona que los mantendrá unidos a pesar de las duras situaciones a las que se tendrán que enfrentar, pero su amor jamás desaparecerá y el hilo rojo del destino jamás se romperá porque el mundo puede ser también muy hermoso.""
{/color}""")
...
define config.main_menu_music = "Sudden.mp3"
...
define config.save_directory = "Eldestinonosune-1575066719"
