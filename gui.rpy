...
define gui.text_color = '#0B1B22'
define gui.interface_text_color = '#000000'


## Tipos y tamaños de letra ####################################################

## El tipo de letra del texto del juego (dialogos)
define gui.text_font = "gui/fonts/ComicNeueSansID.ttf"

## El tipo de letra de los nombres de personajes
define gui.name_text_font = "gui/fonts/Minya.otf"

## El tipo de letra del texto externo al juego.
define gui.interface_text_font = "gui/fonts/JMH Typewriter dry-Thin.otf"
...
define gui.namebox_borders = Borders( 0.3, 0.3, 0.3, 0.3)
