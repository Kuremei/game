...
#Boton de de main_menu en esquina de todo el juegos
screen botaoMenu:
    textbutton ("Menu") action MainMenu() align(0.9, 0.1)
...
screen main_menu():
    ...
    imagebutton idle "C_idle.png" hover "C_hover.png" xpos 1220 ypos 610 focus_mask None action ShowMenu("load") hovered [ Play ("test_two", "sfx/click.mp3") ]

    imagebutton idle "co_idle.png" hover "co_hover.png" xpos 1150 ypos 500 focus_mask None action Start() hovered [ Play ("test_three", "sfx/click.mp3") ]

    imagebutton idle "G_idle.png" hover "G_hover.png" xpos 1155 ypos 760 focus_mask None action ShowMenu("gallery") hovered [ Play ("test_four", "sfx/click.mp3") ]

    imagebutton idle "O_idle.png" hover "O_hover.png" xpos 1154 ypos 887 focus_mask None action ShowMenu("preferences") hovered [ Play ("test_one", "sfx/click.mp3") ]
